...
import math
import numpy as np
from skimage.util import random_noise # type: ignore
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'.\data\mydata\train\images')
    parser.add_argument('--source_xml_path', type=str, default=r'.\data\mydata\train\xml')
    parser.add_argument('--save_img_path', type=str, default=r'.\data\mydata\train\enhance_images')
    parser.add_argument('--save_xml_path', type=str, default=r'.\data\mydata\train\enhance_labels')
